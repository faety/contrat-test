/*
  ...
  SMTP via nodemailer — fonctionne avec n'importe quel fournisseur
  (Hostinger : smtp.hostinger.com port 465, Gmail, Brevo, etc.).

  Variables d'environnement :
    SMTP_HOST     ex. smtp.hostinger.com
    SMTP_PORT     465 (SSL, défaut) ou 587 (STARTTLS)
    SMTP_USER     ex. contact@boyiainstitute.com
    SMTP_PASS     mot de passe de la boîte
    MAIL_FROM     adresse d'expédition (défaut : SMTP_USER)
...
let _transport = null;
function isConfigured() { return !!((HOST && USER && PASS) || _transport); }
...
module.exports = { isConfigured, send, sendReceipt, sendWelcome, sendSaleNotification, _setTransport };
