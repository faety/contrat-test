...
const ECHO_LESSONS = { l1: 8, l2: 11, l3: 15, l4: 16, l5: 14 };
...
module.exports = { PRICES, PACK_COURSES, SUB_PLANS, SUB_COURSES, planPrice, COURSE_NAMES, COURSE_LESSONS, ECHO_LESSONS, ECHO_CERT_LEVELS, isCourse, isLive, verifyWaveSignature, createSession, findByReference, getSession, sessionPaid, sessionExpired };
