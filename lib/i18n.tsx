...
const dictionaries = {
  fr: {
    ...
    "send.pin.hint": "Démo : le code PIN est 1234",
    ...
    "profile.verification.level1": "Niveau 1 — Téléphone vérifié",
  ...
  en: {
    ...
    "send.pin.hint": "Demo: the PIN is 1234",
    ...
    "profile.verification.level1": "Level 1 — Phone verified",
