...
async function signup(input) {
  ...
  const user = await store.userCreate({
    ...
    whatsapp: cleanName(input.whatsapp, 24), prefix: cleanName(input.prefix, 6) || '+225', points: 20,
  });
...
module.exports = {
  health, checkout, couponPreview, adminCoupons, adminStats, webhook, order, welcome, afterPaid,
  signup, authRequest, authVerify, me, meEnroll, meProgress, logout,
