const { checkout, readRawBody, baseUrlFrom } = require('../lib/handlers');

/* On lit le corps nous-mêmes (cohérence avec le webhook). */
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const r = await checkout(input, baseUrlFrom(req));
